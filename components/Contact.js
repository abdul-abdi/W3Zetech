...
export default function Contact() {
  ...
  return (
    <section id="contact" className="min-h-screen flex flex-col justify-between relative overflow-hidden">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 z-10 py-10 sm:py-20 flex-grow flex flex-col">
        <motion.div 
          className="bg-background bg-opacity-80 backdrop-blur-lg rounded-xl shadow-2xl p-6 sm:p-12 relative overflow-hidden flex-grow flex flex-col"
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        >
          <motion.h2 
            className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 sm:mb-12 text-center bg-gradient-to-r from-accent-1 to-accent-2 text-transparent bg-clip-text"
            initial={{ opacity: 0, y: -50 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
          >
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:W3Zetech@gmail.com" className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500 hover:from-purple-500 hover:to-blue-500 transition-all duration-300">W3Zetech@gmail.com</a>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500">+254 720 987311 - Abdi</p>
                  <p className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">+254 780 519700 - Nelly</p>
                  <p className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500">+254 794 213469 - Fadhil</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <a 
                    ...
                    className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-orange-500 hover:to-yellow-400 transition-all duration-300"
                  >
                    Zetech University
                  </a>
                </div>
            ...
            >
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-background border border-blue-500 rounded-lg px-4 py-2 text-text-primary focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
                  required
                />
              </div>
              <div>
                ...
                <input 
                  ...
                  onChange={handleChange} 
                  className="w-full bg-background border border-green-400 rounded-lg px-4 py-2 text-text-primary focus:outline-none focus:ring-2 focus:ring-green-400 transition-all duration-300"
                  required
                />
              </div>
              <div>
                ...
                <textarea 
                  ...
                  onChange={handleChange} 
                  className="w-full bg-background border border-yellow-400 rounded-lg px-4 py-2 text-text-primary focus:outline-none focus:ring-2 focus:ring-yellow-400 transition-all duration-300"
                  rows="4"
                  required
                />
              </div>
          ...
          <motion.div
            ...
            className="w-full h-48 sm:h-64 md:h-80 relative rounded-xl overflow-hidden"
          >
            <iframe
